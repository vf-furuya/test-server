...
function changePage(myPage) {
	...
	document.fList.action = "account_l.php";
	document.fList.submit(true);
	return false;
}
// ソート指定
...
<div id="wrapper">
	...
	<div id="contents" class="clearfix">
		...
		<div id="main_contents" class="mypage">
			...
			<div class="mt-18 right"><a href="javascript:void(0);" onclick="javascript:goPageWithCDandWork('account_s.php', -1, ___WORK_NEW__); return false;"><img src="img/admin/btn_newcreation_small.png"></a></div>
				...
				<table class="table-long">
					<thead>
						<tr>
							...
							<td class="center" nowrap><a href="javascript:void(0);" onclick="javascript:changeSort(7); return false;">ログインID</a></td>
							<td class="left" nowrap><a href="javascript:void(0);" onclick="javascript:changeSort(3); return false;">名前</a></td>
							<td class="left" nowrap><a href="javascript:void(0);" onclick="javascript:changeSort(5); return false;">メールアドレス</a></td>
							<td class="w60 center" nowrap>アクション</td>
						</tr>
					</thead>
					<tbody>
__IfResults____AccountListLoop__
						<tr>
							<td class="center">__s::r::AccountCD__</td>
							<td class="center">__s::r::AccountID__</td>
							<td class="left">__s::r::AccountName__</td>
							<td class="left">__s::r::EMail__</td>
							<td class="center">
								<a class="pr5 tipsy_s" original-title="編集" href="javascript:void(0);" onclick="javascript:goPageWithCDandWork('account_s.php', __AccountCD__, ___WORK_EDIT__); return false;"><img src="img/admin/icon-edit.gif" alt="編集" /></a>
__IfNotAdminAccount__								<a class="pr5 tipsy_s" original-title="削除" href="javascript:void(0);" onclick="javascript:goPageWithCDandWork('account_c.php', __AccountCD__, ___WORK_DELETE__); return false;"><img src="img/admin/icon-delete.gif" alt="削除" /></a>__IfNotAdminAccount__
							</td>
						</tr>
__AccountListLoop__
__IfResults__
...
__IfNoResults__
				...
				<div class="mt5 right"><a href="javascript:void(0);" onclick="javascript:goPageWithCDandWork('account_s.php', -1, ___WORK_NEW__); return false;"><img src="img/admin/btn_newcreation_small.png"></a></div>
				__IfPaging__
