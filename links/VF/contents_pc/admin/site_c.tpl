...
__IfAdminRoot__
					...
					<tr>
						...
						<td>__s::r::pRedirectUrl__</td>
					</tr>
<!--
					<tr>
						<th>リダイレクト深度<span>*</span>:</th>
						<td>__s::r::pRedirectDepth__</td>
					</tr>
					<tr>
...
__TagListLoop__
								<tr>
									<td class="TagIndex">__TagIndex__　　<span class="whitebold">[__s::HeadFlagSelected__]</span></td>
								</tr>
								<tr>
									<td><p>__s::r::Tag__</p>
									</td>
...
__IfComplete__
				<a href="javascript:void(0);" onclick="javascript:goPageWithCD('site_e.php', __editSiteCD__); return false;"><img src="img/admin/btn_save.png" alt="登録" /></a>　
				<a href="javascript:void(0);" onclick="javascript:goPageWithWork('site_s.php', ___WORK_BACK__); return false;"><img src="img/admin/btn_back.png" alt="戻る" /></a>　
__IfComplete__
__IfDelete__
				<a href="javascript:void(0);" onclick="javascript:goPageWithCDandWork('site_e.php', __editSiteCD__, ___WORK_DELETE__); return false;"><img src="img/admin/btn_delet.png" alt="削除" /></a>　
