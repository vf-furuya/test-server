...
function changePage(myPage) {
	...
	document.fList.action = "site_l.php";
	document.fList.submit(true);
	return false;
}
// ソート指定
...
<div id="wrapper">
	...
	<div id="contents" class="clearfix">
		...
		<div id="main_contents" class="mypage">
			...
			<div class="mt-18 right"><a href="javascript:void(0);" onclick="javascript:goPageWithCDandWork('site_s.php', -1, ___WORK_NEW__); return false;"><img src="img/admin/btn_newcreation_small.png"></a></div>

			<div class="box-container">
				<table class="table-long">
					<thead>
						<tr>
							<td class="center" nowrap><a href="javascript:void(0);" onclick="javascript:changeSort(1); return false;">管理番号</a></td>
							<td class="center" nowrap><a href="javascript:void(0);" onclick="javascript:changeSort(7); return false;">サイト番号</a></td>
							<td class="center" nowrap><a href="javascript:void(0);" onclick="javascript:changeSort(5); return false;">サイト名</a></td>
							<td class="left" nowrap><a href="javascript:void(0);" onclick="javascript:changeSort(9); return false;">URL</a><br>リンクURL</td>
							<td class="w60 center" nowrap>アクション</td>
						</tr>
					</thead>
					<tbody>
__IfResults____SiteListLoop__
						<tr>
							<td class="center">__SiteCD__</td>
							<td class="center">__SiteIndex__</td>
							<td class="left">__s::r::SiteName__</td>
							<td class="left">__s::r::RedirectUrl__<br>__s::r::LinkUrl__</td>
							<td class="center">
								<a class="pr5 tipsy_s" original-title="編集" href="javascript:void(0);" onclick="javascript:goPageWithCDandWork('site_s.php', __SiteCD__, ___WORK_EDIT__); return false;"><img src="img/admin/icon-edit.gif" alt="編集" /></a>
								<a class="pr5 tipsy_s" original-title="削除" href="javascript:void(0);" onclick="javascript:goPageWithCDandWork('site_c.php', __SiteCD__, ___WORK_DELETE__); return false;"><img src="img/admin/icon-delete.gif" alt="削除" /></a>
							</td>
						</tr>
__SiteListLoop__
__IfResults__
__IfNoResults__
						<tr>
							<td colspan="5"><div class="list_err">該当するデータは見付かりませんでした。</div></td>
						</tr>
__IfNoResults__
					</tbody>
				</table>

				<div class="mt5 right"><a href="javascript:void(0);" onclick="javascript:goPageWithCDandWork('site_s.php', -1, ___WORK_NEW__); return false;"><img src="img/admin/btn_newcreation_small.png"></a></div>
				__IfPaging__
