...
<div id="wrapper">
	...
	<div id="contents" class="clearfix">
		...
		<div id="main_contents" class="mypage">
			...
			<div class="box_form">
				<div class="mt80 mb80 b center">データを%%IfUpdate%%更新%%IfUpdate%%%%IfDelete%%削除%%IfDelete%%しました。</div>
			</div>
			<div class="mt10 center">
				<a href="javascript:void(0);" onclick="javascript:goPage('__FilePrefix___l.php'); return false;"><img src="/img/admin/btn_list_back.png" alt="一覧へ戻る" /></a>
			</div>
		</div><!--main_contents -->
